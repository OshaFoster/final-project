...
function AddComponent(props){
    ...
    return(
        <div>
            ...
            <input className="addInput"onChange={props.handleChange}value={props.inputs.description}name="description"type="text"placeholder="Recipe Description: Required"></input>
